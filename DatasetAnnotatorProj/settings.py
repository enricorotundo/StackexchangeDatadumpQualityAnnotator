"""
Django settings for DatasetAnnotatorProj project.
...
SECRET_KEY = 'v5lw69el55uv8znq&ma1y5pa6r!n3vtih)xmr7wo^pd2f_s5nt'
...
ROOT_URLCONF = 'DatasetAnnotatorProj.urls'
...
WSGI_APPLICATION = 'DatasetAnnotatorProj.wsgi.application'
